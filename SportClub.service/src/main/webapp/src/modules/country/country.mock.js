(function (ng) {
    /* var mod = ng.module('MockModule');

    mod.run(['$httpBackend', 'country.context', 'MockModule.mockRecords', 'country.skipMock', 'MockModule.baseUrl', function ($httpBackend, context, mockRecords, skipMock, baseUrl) {
            if (skipMock) {
